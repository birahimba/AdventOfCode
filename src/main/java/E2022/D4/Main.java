...
public class Main {
	...
	public static void main(String[] args) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(inputFile))) {
			...
			while ((line = br.readLine()) != null) {
				...
				// Exo 2: compter le nombre de paires d'affectation avec des sections se
				// chevauchant
		...
		System.out.println(
				"Nombre de paires d'affectation où l'une contient entièrement l'autre : " + countFullyContains);
	...
	private static SectionAssignment parseSectionAssignment(String assignmentString) {
		...
		return null;// new SectionAssignment(start, end);
	}
}
